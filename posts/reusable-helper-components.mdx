...
- `useSearchParams` lets us read the current URL's query string. It returns a read-only version of the [`URLSearchParams`](https://developer.mozilla.org/en-US/docs/Web/API/URLSearchParams) interface.[^2]
...
I haven't tried it so I asked [ChatGPT](https://chatgpt.com/share/69213ead-3740-8002-bc49-1e2b8c661f82) to do it and it does look way more simple.
