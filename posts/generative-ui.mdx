...
summary: Experimenting with generative UI and structured output with Vercel AI SDK.
---
...
Me and my friends built [Moneasy](/projects/moneasy), a simple chatbot to manage financial transactions for small businesses. We built this for a hackathon last year and got a spot in the finals.
