...
There has also been concerns on how Vercel handles this situation which stirs up the drama. But I will not be covering it in this post and will focus on the main issue instead.
...
Only using middleware for your authorization is not enough. This exploit has made it clear, I will explain about this shortly in this post.
