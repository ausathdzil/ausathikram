export const metadata = {
  ...
  openGraph: {
    url: 'https://ausathikram.com/blog/reusable-helper-components',
...
<figure>
  ...
  <figcaption>— Francois Best, nuqs</figcaption>
</figure>
...
function generatePagination(currentPage: number, totalPages: number) {
  // From the helper function above…
}
...
You need to make sure and adjust your pagination meta so it matches what you actually have from your data source.
...
You can also use other variables from your paginationMeta to disable the previous and next link.
...
You are also most likely be able to implement this components in your codebase with nuqs as it is a dedicated, type-safe search params state management library for React.
...
I haven't tried it so I asked ChatGPT to do it and it does look way more simple.
