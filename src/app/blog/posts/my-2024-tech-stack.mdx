...
- **Database**: Neon
- **ORM**: Drizzle ORM
- **Authentication**: Roll my own or Auth.js
- **Other Tools**: Zod
...
I don't think writing raw SQL queries is bad. There are security concerns, especially with SQL injections. Vercel Postgres SDK uses something called **parameterized queries** to prevent this. However, I still prefer using an ORM for my projects.

I chose Drizzle because it strikes a great balance between being a full-featured ORM and maintaining SQL-like syntax. Here's an example of how I use Drizzle:
...
I like to use [Auth.js](https://github.com/nextauthjs/next-auth) when I need OAuth logins. It's easy to set up and has a lot of providers. However, it is still in beta and has some known issues. For my personal projects where I typically just need a simple email password login, I usually roll my own authentication system.
