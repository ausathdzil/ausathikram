...
on my last post, we learned how to [validate forms](/blog/form-validation) using **useActionState**. one problem that arises when submitting a form directly with the action attribute is that the form will be reset after submission.
